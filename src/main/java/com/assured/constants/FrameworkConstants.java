...
public final class FrameworkConstants {
    ...
    public static final String EXCEL_PROVIDER_DATA = PropertiesHelpers.getValue("EXCEL_PROVIDER_DATA");
    public static final String EXCEL_CMS_PRODUCTS_USER = PropertiesHelpers.getValue("EXCEL_CMS_PRODUCTS_USER");
    public static final String ASSURED_CRYPTOGRAPHY_KEY = PropertiesHelpers.getValue("assured_cryptography_key");

    public static final String BROWSER = PropertiesHelpers.getValue("BROWSER");
    public static final String URL_STAGING = PropertiesHelpers.getValue("URL_STAGING");
